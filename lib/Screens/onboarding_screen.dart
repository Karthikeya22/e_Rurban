...
List<OnboardingModel> tabs = [
  OnboardingModel(
    ...
    'The Shyam Prasad Mukherji Rurban Mission (SPMRM) was launched by the Ministry of Rural Development (MoRD) in 2016.',
  ),
  OnboardingModel(
    'assets/bot.json',
    'Aim of Shyam Prasad Mukherji',
    'The main aim of the mission is to bridge the gap between rural and urban population by providing equal facilities, technology, social-economic development.',
  ),
  OnboardingModel(
    'assets/stats.json',
    'Object of the Rurban Mission',
